...
class TestUserProfileForm:
    def test_user_profile_form_valid_data(self, create_user_profile):
    ...
    def test_user_profile_form_invalid_birth_date(self, birth_date, expected_error):
    ...
    def test_user_profile_form_invalid_postal_code(self, postal_code, expected_error):
        ...
        if expected_error:
            assert (
                not form.is_valid()
            ), "Form should be invalid for invalid postal_code."
    ...
    def test_user_profile_form_invalid_phone_number(self, phone_number, expected_error):
