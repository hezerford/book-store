...
class TestUserProfile:
    def test_userprofile(self, existing_user, create_user_profile):
        user_profile = create_user_profile()
        assert (
            str(user_profile) == existing_user.username
        ), "__str__ does not return the correct username."

    def test_userprofile_with_data(self, existing_user):
    ...
    def test_userprofile_names(self, create_user_profile):
    ...
    def test_userprofile_picture_path(self, existing_user, create_user_profile):
        user_profile = create_user_profile()
    ...
    def test_userprofile_favorite_books(self, create_user_profile, create_book):
        user_profile = create_user_profile()
    ...
    def test_userprofile_birth_date(self, create_user_profile):
