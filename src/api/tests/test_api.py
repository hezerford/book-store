...
class TestBookAPI:
    def test_all_books_api(self, authenticated_API_client, create_three_books):
    ...
    def test_book_detail_api(self, authenticated_API_client, create_book):
        book = create_book()
    ...
    def test_discounted_book_list_api(self, authenticated_API_client, create_book):
...
class TestBookSearchAPI:
    def test_book_search_api(self, authenticated_API_client, create_book):
        create_book(
            title="Python Book",
